...
eval "aider --no-show-model-warnings --no-check-update --yes-always --model $MODEL --editor-model $EDITOR_MODEL --weak-model $WEAK_MODEL --edit-format udiff --model-settings-file ../.aider.model.settings.yml --message \"${PROMPT}\""
